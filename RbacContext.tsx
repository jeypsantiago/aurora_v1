...
import { getEffectivePermissions, hasPermission, hasAnyPermission } from './services/permissions';
...
export const RbacProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const can = (permission: Permission) => hasPermission(userPermissions, permission);
    const canAny = (permissions: Permission[]) => hasAnyPermission(userPermissions, permissions);
    ...
    return (
        <RbacContext.Provider value={{ permissions: userPermissions, can, canAny, visibleNavItems }}>
            {children}
