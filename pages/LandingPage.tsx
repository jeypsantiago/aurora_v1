...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] dark:bg-[#020202] text-zinc-900 dark:text-zinc-100 selection:bg-blue-600/30 transition-colors duration-1000 overflow-x-hidden font-sans">
      ...
      <nav className={`fixed top-0 w-full z-[1000] transition-all duration-700 px-4 sm:px-12 ${scrolled ? 'pt-4' : 'pt-8'
        }`}>
        <div className={`max-w-7xl mx-auto h-16 sm:h-20 flex items-center justify-between px-8 rounded-[24px] transition-all duration-700 ${scrolled
          ...
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate('/')}>
            ...
            <div className="flex flex-col leading-none">
              <span className="text-sm font-[900] uppercase tracking-tighter">PSA Aurora</span>
              <span className="text-[8px] text-zinc-500 font-bold uppercase tracking-[0.4em] mt-1 opacity-60">Provincial Hub</span>
            </div>
          </div>
      ...
      <section className="relative pt-44 pb-20 sm:pt-60 sm:pb-32 px-6 sm:px-12 max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="max-w-4xl space-y-10">
          ...
          <h1 className="text-3xl sm:text-5xl lg:text-7xl font-[1000] tracking-tight leading-[1.05] text-zinc-900 dark:text-white animate-reveal opacity-0 stagger-2">
            Pioneering Provincial <br />
            <span className="text-blue-600 bg-clip-text">Data Integrity.</span>
          </h1>

          <p className="text-lg sm:text-xl text-zinc-500 dark:text-zinc-400 font-medium max-w-2xl mx-auto leading-relaxed animate-reveal opacity-0 stagger-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-24 w-full animate-reveal opacity-0 stagger-5">
          {[
            ...
            <div key={i} className="glass p-8 rounded-[40px] border border-zinc-200/50 dark:border-zinc-800/50 hover-lift group cursor-default transition-all shadow-xl shadow-black/5">
              ...
              <span className="text-2xl font-black block tracking-tighter mb-2">{stat.val}</span>
              <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-[0.2em]">{stat.label}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="services" className="py-28 px-6 sm:px-12 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-10 animate-reveal opacity-0 stagger-1">
          <div className="space-y-4">
            <h2 className="text-[11px] font-bold uppercase tracking-[0.5em] text-blue-600">Core Architecture</h2>
            <h3 className="text-3xl sm:text-5xl font-[1000] tracking-tight">The Provincial Hub.</h3>
          </div>
          <p className="max-w-md text-zinc-500 dark:text-zinc-400 text-base font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 p-12 rounded-[56px] bg-blue-600 text-white relative group overflow-hidden shadow-2xl shadow-blue-600/20 animate-reveal opacity-0 stagger-2">
            ...
            <h4 className="text-3xl font-[1000] mb-4 tracking-tight">Registry Archive</h4>
            <p className="text-blue-100 text-base font-medium leading-relaxed mb-12 max-w-sm">Official archival of Birth, Marriage, and Death certificates with province-wide encrypted lookup.</p>
          ...
          <div className="lg:col-span-2 p-12 rounded-[56px] glass border border-zinc-200 dark:border-zinc-800 flex flex-col sm:flex-row items-center gap-12 group shadow-sm animate-reveal opacity-0 stagger-5">
            ...
            <div className="flex-1 space-y-4">
              <h4 className="text-2xl font-[1000] tracking-tight uppercase">Statistical Analytics</h4>
              <p className="text-base text-zinc-500 font-medium leading-relaxed">Provincial economic mapping, census processing, and demographics analysis hub.</p>
      ...
      <section id="updates" className="py-28 px-6 sm:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start">
          <div className="lg:col-span-5 space-y-10 animate-reveal opacity-0 stagger-1">
            <div className="space-y-4">
              <h2 className="text-[11px] font-bold uppercase tracking-[0.5em] text-blue-600">Provincial Newsroom</h2>
              <h3 className="text-3xl lg:text-5xl font-[1000] tracking-tight leading-[1.1]">The Latest <br /> Advisories.</h3>
            </div>
            <p className="text-lg text-zinc-500 font-medium leading-relaxed">Stay updated with official schedules, mobile mission routes, and public notices from PSA Aurora.</p>
            <div className="flex items-center gap-4 pt-2">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-20 pb-20 border-b border-white/5">
            <div className="lg:col-span-5 space-y-12 animate-reveal opacity-0 stagger-1">
              ...
              <p className="text-2xl sm:text-4xl font-[1000] tracking-tighter leading-none text-zinc-500">
